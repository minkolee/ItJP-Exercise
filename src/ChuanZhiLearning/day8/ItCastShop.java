package ChuanZhiLearning.day8;

/**
 * 修改了一下程序,加上了每次调用选择的返回值,然后根据返回值判断程序是否结束
 */
...
public class ItCastShop {
    ...
    public static int chooseFunction(ArrayList<FruitItem> list) {
        System.out.print("请您输入要操作的功能序号：");
